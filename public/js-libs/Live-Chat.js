		...
		(n(7).inspectSource = function (e) {
			...
			(e.exports = function (e, t, n, s) {
				...
				c && (r(n, "name") || i(n, "name", t)),
					e[t] !== n &&
						(c && (r(n, a) || i(n, a, e[t] ? "" + e[t] : l.join(String(t)))),
						e === o ? (e[t] = n) : s ? (e[t] ? (e[t] = n) : i(e, t, n)) : (delete e[t], i(e, t, n)));
			...
			n(14)(function () {
				...
				? function (e, t) {
						for (var n = a(e), c = arguments.length, l = 1, p = i.f, u = r.f; c > l; )
							for (
								var f, d = s(arguments[l++]), g = p ? o(d).concat(p(d)) : o(d), h = g.length, b = 0;
								h > b;
			...
			c = function (e, t, n) {
				...
				(l.initialize = function () {
					...
					(l.requireWidget = function (e) {
						"string" != typeof e &&
							l.logError("Widget Public ID required and should be a string", { pid: e }),
					...
					(l.getWidgetIdByElement = function (e) {
						return "div" === e.tagName.toLowerCase()
							? l.getEappsClass(e).replace("elfsight-app-", "")
					...
					(l.initWidget = function (e) {
						...
						if (o) {
							if (!o.status)
								return void l.logError(
									'Widget "' + t + '" can`t be initialized because ' + o.reason,
									e
								);
							o.data && ((o.data.id = t), (o.data.platform = !0)),
							...
							var r = new XMLHttpRequest(),
								a =
									(e.eappsCustomPlatformUrl
										? e.eappsCustomPlatformUrl
										: "https://apps.elfsight.com") + "/p/boot/",
				...
				case "index":
					return function (e, n, o) {
						return (
							(t = /\[(\d*)\]$/.exec(e)),
							(e = e.replace(/\[\d*\]$/, "")),
							t ? (void 0 === o[e] && (o[e] = {}), void (o[e][t[1]] = n)) : void (o[e] = n)
						);
					};
				case "bracket":
					return function (e, n, o) {
					...
					? (e.split("&").forEach(function (e) {
					  ...
					  Object.keys(i)
							...
							.reduce(function (e, t) {
								var n = i[t];
								return (
									Boolean(n) && "object" === o(n) && !Array.isArray(n) ? (e[t] = s(n)) : (e[t] = n), e
								);
							}, Object.create(null)))
					: i;
			}),
						...
						window.postMessage(
							{
								...
								data: { settings: t.settings, app_slug: t.app, public_id: t.id, platform: "eapps" },
							},
							"*"
						);
					}),
					...
					(n.initToolbar = function (e, t) {
						...
						n.body.innerHTML =
							'<div class="eapps-widget-toolbar">\n                <div class="eapps-widget-toolbar-panel-wrapper">\n                    <div class="eapps-widget-toolbar-panel-only-you">Panel only seen by widget owner</div>\n                    \n                    <div class="eapps-widget-toolbar-panel">\n                        <a href="'
								...
								.concat(
									t.app,
									"/?utm_source=clients&utm_medium=user-panel&utm_campaign=elfsight-icon&utm_content="
								)
								...
								.concat(
									t.id,
									"/?utm_source=clients&utm_medium=user-panel&utm_campaign=edit-widget&utm_content="
								)
								.concat(t.app, "&utm_term=")
								.concat(
									t.websiteUrl,
								...
								.concat(
									t.app,
									"/?show_pricing=true&utm_source=clients&utm_medium=user-panel&utm_campaign=extend-limits&utm_content="
								)
								.concat(t.app, "&utm_term=")
									...
									e.buffer.forEach(function (t) {
										if (e.steps && !e.steps.length)
											...
											e.steps.forEach(function (o, i) {
												o.app == t.app &&
													o.widgetId == t.widgetId &&
													o.event == t.event &&
													((e.steps[i].count += t.count), (n = !0));
											}),
												n ||
													e.steps.push({
														app: t.app,
