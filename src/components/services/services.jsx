			...
			<div className="services-category" data-aos="fade-up">
				...
				<div className="serve-box" data-aos="fade-up" data-aos-delay="550">
					...
					<p className="serve-desc">
						I make designs and websites from small startups to large companies. I'm always aware of modern trends of design and
						programming. I can assure you high quality of my work & satisfaction over time.
					</p>
				</div>
				<div className="serve-box" data-aos="fade-down" data-aos-delay="250">
					...
					<p className="serve-desc">
						I can work on any website from scratch to the end of the project with a responsive design On all devices [Mobile,
						Ipad, Labtop, PC] in a very fast and standard time
					</p>
				</div>
			</div>
		</section>
