				...
				<div className="right-section">
					<div className="about-content">
						...
						<p className="content-description" data-aos="fade-up" data-aos-delay="450" data-offset="0">
							...
							of experience. I got fairly extensive knowledge in the frontend, I can work with PSD as well as with templates
							and realize any functionality with your website. I have experience with high-loaded projects. Skills
						</p>
					</div>
				</div>
			</div>
